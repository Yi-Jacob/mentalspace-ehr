...
import { BarChart3, FileText, AlertTriangle, Clock, CheckCircle, Download } from 'lucide-react';
    ...
    return (
      <PageLayout variant="simple">
        <PageHeader
          ...
          description="Claims status, denials, and accounts receivable reports"
        />
        <div className="text-center py-8">Loading billing reports...</div>
      </PageLayout>
    );
  }
