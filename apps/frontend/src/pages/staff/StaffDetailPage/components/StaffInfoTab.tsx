...
export const StaffInfoTab: React.FC<StaffInfoTabProps> = ({ staff }) => {
  ...
  const hasPhoneNumbers = staff.mobilePhone || staff.workPhone || staff.homePhone || staff.phoneNumber;
        ...
        <InfoSection title="Employment Details">
            <div className="grid grid-cols-1 gap-4">
              <div className="flex items-center space-x-2">
                ...
                <InfoDisplay 
                  label="Hire Date" 
                  value={staff.hireDate ? formatDateOfBirth(staff.hireDate) : null} 
                />
              </div>
              <InfoDisplay 
                label="Member Since" 
          ...
          <InfoSection title="Professional Information">
            <div className="grid grid-cols-1 gap-4">
              <InfoDisplay label="Employee ID" value={staff.employeeId} />
              <InfoDisplay label="Job Title" value={staff.jobTitle} />
              <div className="flex items-center space-x-2">
                <Building className="h-4 w-4 text-gray-400" />
                <InfoDisplay label="Department" value={staff.department} />
              </div>
              ...
              {staff.billingRate && (
                <div className="space-y-1">
                  ...
                  <div className="flex items-center space-x-2 text-sm">
                    ...
                    <span className="font-medium text-gray-900">${staff.billingRate}/hour</span>
                  </div>
                </div>
              )}
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-500 block">Can Bill Insurance</label>
                <Badge variant={staff.canBillInsurance ? "default" : "secondary"} className="text-xs">
                  {staff.canBillInsurance ? 'Yes' : 'No'}
                </Badge>
              </div>
            </div>
          </InfoSection>
